  ...
  head: () => ({
    meta: [
      { title: "Log in — TryVerse" },
      {
        name: "description",
        content:
          "Log in to TryVerse — continue as a shopper or sign in to your brand studio.",
      },
    ],
  }),
...
function LoginSelector() {
  const cards = [
    {
      to: "/login/shoppers" as const,
      icon: ShoppingBag,
      eyebrow: "Shopper Login",
      title: "Continue as Shopper",
      desc: "Try outfits before buying and manage your personal try-on results.",
      cta: "Continue as Shopper",
      tone: "violet" as const,
    },
    {
      to: "/login/brands" as const,
      icon: Building2,
      eyebrow: "Brand Login",
      title: "Continue as Brand",
      desc: "Create AI fashion visuals and manage your clothing brand studio.",
      ...
      <main className="relative pt-[120px] pb-32">
        <section className="relative">
          ...
          <div className="mx-auto max-w-[860px] px-6 sm:px-10 text-center">
            <Reveal as="div" className="eyebrow justify-center">Log in</Reveal>
            <h1 className="font-display mt-6 text-4xl sm:text-5xl lg:text-[56px] leading-[1.05]">
              <RevealLines lines={["Log in to TryVerse"]} step={130} />
            </h1>
