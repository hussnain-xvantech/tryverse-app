...
import { ArrowRight, ShoppingBag, Building2, Check } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "Pricing — TryVerse" },
      {
        name: "description",
        content:
          "Choose your TryVerse pricing — personal try-on plans for shoppers or brand studio plans for fashion brands.",
      },
      { property: "og:title", content: "Pricing — TryVerse" },
      {
        property: "og:description",
        content: "Pick the right TryVerse plan — for shoppers or for brands.",
      },
    ],
  ...
  const cards = [
    {
      ...
      title: "Personal try-on plans",
      desc: "Try clothes virtually, get stylist help, and create AI looks from your own photo.",
      bullets: ["5 free daily credits", "Virtual Try-On", "AI Fashion Stylist", "Pose Studio"],
      cta: "View Shopper Pricing",
    ...
    },
    {
      ...
      icon: Building2,
      eyebrow: "For Brands",
      title: "Brand studio plans",
      desc: "AI photoshoots, ghost mannequin, videos and virtual try-on widget for your fashion store.",
      bullets: ["AI Photoshoot", "Ghost Mannequin", "Brand Widget", "Analytics & catalog"],
      cta: "View Brand Pricing",
        ...
        <section className="relative">
          ...
          <div className="mx-auto max-w-[860px] px-6 sm:px-10 text-center">
            ...
            <h1 className="font-display mt-6 text-4xl sm:text-5xl lg:text-[60px] leading-[1.05]">
              <RevealLines lines={["Choose Your", "Pricing Path"]} accentIndices={[1]} step={130} />
            </h1>
            <Reveal as="p" delay={340} className="mt-6 text-base sm:text-lg text-white/70 max-w-xl mx-auto leading-relaxed">
              TryVerse works for both shoppers and fashion brands. Pick the plan that fits you.
            </Reveal>
          </div>
        </section>
                      ...
                      <ul className="mt-6 space-y-2.5">
                        {c.bullets.map((b) => (
                          <li key={b} className="flex items-center gap-2.5 text-[14px] text-white/80">
                            <span className="grid h-5 w-5 place-items-center rounded-full bg-violet/20 text-violet">
